...
class AbstractVariantComparer(object, metaclass=ABCMeta):
    @abstractmethod
...
class VariantComparerNoAlternate(AbstractVariantComparer):
    def equals(self, variant1, variant2):
        ...
        return (
            ...
            and variant1.POS == variant2.POS
            and variant1.REF == variant2.REF
        )
...
class VariantComparerWithAlternate(AbstractVariantComparer):
    def equals(self, variant1, variant2):
        ...
        return (
            ...
            and variant1.POS == variant2.POS
            and variant1.REF == variant2.REF
            and set([str(alternate) for alternate in variant1.ALT])
