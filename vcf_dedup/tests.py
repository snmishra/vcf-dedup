...
class VcfDedupTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.no_duplicated = os.path.join(
            self.INPUT_FOLDER, "vcf_without_duplicated_variants.vcf"
        )
    ...
    def test1_0(self):
        ...
        config = {
            ...
            "variant_caller": constants.STRELKA_VARIANT_CALLER,
            "selection_method": constants.SELECTION_METHOD_AF,
            "equality_mode": constants.INCLUDE_ALTERNATE,
            "sample_idx": "0",
            "sample_name": "sample",
            "sort_vcf": True,
            "sort_threads": 1,
    ...
    def test1_3(self):
        ...
        config = {
            "input_vcf": input_vcf,
            "output_vcf": output_vcf,
            "variant_caller": constants.PLATYPUS_VARIANT_CALLER,
            "selection_method": constants.SELECTION_METHOD_ALLELE_CALLS,
            "equality_mode": constants.INCLUDE_ALTERNATE,
            "sort_vcf": True,
            "sort_threads": 1,
            "temp_folder": "",
    ...
    def test1_4(self):
        ...
        config = {
            "input_vcf": input_vcf,
            "output_vcf": output_vcf,
            "variant_caller": constants.STARLING_VARIANT_CALLER,
            "selection_method": constants.SELECTION_METHOD_ALLELE_CALLS,
            "equality_mode": constants.INCLUDE_ALTERNATE,
            "sample_idx": "0",
            "sample_name": "sample",
    ...
    def test1_6(self):
        ...
        config = {
            "input_vcf": input_vcf,
            "output_vcf": output_vcf,
            "variant_caller": constants.GENERIC_VARIANT_CALLER,
            "selection_method": constants.SELECTION_METHOD_AF,
            "equality_mode": constants.INCLUDE_ALTERNATE,
            "sort_vcf": True,
            "sort_threads": 1,
